...
class _ProductScreenState extends State<ProductScreen> with ProductValidator {
                  ...
                  return ListView(
                    ...
                    children: [
                      ...
                      ProductsSizes(
                        ...
                        validator: (s) {
                          if (s.isEmpty)
                            return ''; //quando retorna uma string, mesmo que sem erro, o flutter entende que tem erro
                          return null; //o retorno null é quando não tem erro
                        },
                      )
                    ],
                  );
  ...
  void saveProduct() async {
    if (_formKey.currentState.validate()) {
      _formKey.currentState.save(); //vai chamar o onsave  de cada campo abaixo

      _scaffoldKey.currentState.showSnackBar(
          //é preciso criar a key la em cima, usar ela no scaffold, para poder usar o snackbar fora do scaffold quando está na mesma classe, senao poderia fazer of(context)
          SnackBar(
        content: Text(
          'Salvando produto...',

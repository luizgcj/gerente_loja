...
class OrdersBloc extends BlocBase {
  ...
  List<DocumentSnapshot> _orders = []; //Poderia colocar uma lista de Map, mas segundo o Daniel Ciolfi, dessa maneira fica mais facil, pode ser excluido, regredir e avançar mais facilmente
